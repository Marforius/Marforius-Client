		...
		elseif ( type == "BN_INLINE_TOAST_CONVERSATION" ) then
			...
			if(strlen(arg6) > 0) then
				if ( arg6 == "GM" ) then
					...
					-- this was sent by a GM
					pflag = "\124cff00B4FF\124h <GM>\124h\124r ";
				elseif ( arg6 == "DEV" ) then
					-- this was sent by a Dev
					-- icons taken out because of the spacing problems they have/had since icons were first added to chat in 2.4?
					-- bug persisted for, what? three years until they finally fixed it in 4.0
					-- Tag color is lightblue like bnet friend plates are (staff plates are supposed to be the same color; light blue)
					-- not playing with the same arguements over in the GM Chat window, because its already fixed there
					-- (was that window made specifically because of this bug?) lol.
					pflag = "\124cff00B4FF\124h <DEV>\124h\124r ";					
				else
